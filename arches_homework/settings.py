"""
Django settings for arches_homework project.
"""
...
APP_NAME = 'arches_homework'
APP_ROOT = os.path.dirname(os.path.abspath(inspect.getfile(inspect.currentframe())))
STATICFILES_DIRS =  (os.path.join(APP_ROOT, 'media'),) + STATICFILES_DIRS

DATATYPE_LOCATIONS.append('arches_homework.datatypes')
FUNCTION_LOCATIONS.append('arches_homework.functions')
SEARCH_COMPONENT_LOCATIONS.append('arches_homework.search_components')
...
SECRET_KEY = '1tt!)cqdqw#!5qn%ldy@@wwq4c7m#gs1l+)9!gm=y1k-dam@*n'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ROOT_URLCONF = 'arches_homework.urls'

# a prefix to append to all elasticsearch indexes, note: must be lower case
ELASTICSEARCH_PREFIX = 'arches_homework'

ELASTICSEARCH_CUSTOM_INDEXES = []
# [{
#     'module': 'arches_homework.search_indexes.sample_index.SampleIndex',
...
WSGI_APPLICATION = 'arches_homework.wsgi.application'
...
SESSION_COOKIE_NAME = 'arches_homework'
